...
class MainActivity : AppCompatActivity() {
    private val articles = mutableListOf<DisplayItem>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            (application as ItemApplication).db.articleDao().getAll().collect { databaseList ->
                ...
                try {
                    ...
                    parsedJson.response?.docs?.let { list ->
                        lifecycleScope.launch(IO) {
                            (application as ItemApplication).db.articleDao().deleteAll()
